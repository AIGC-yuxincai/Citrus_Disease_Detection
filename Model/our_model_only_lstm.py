...
class Ourmodel_only_lstm(nn.Module):
    ...
    def __init__(self,
                 ...
                 groups=1,
                 width_per_group=64):
        super(Ourmodel_only_lstm, self).__init__()
...
def our_model_only_lstm(num_classes=1000, channels=44,include_top=True):
    # https://download.pytorch.org/models/resnet50-19c8e357.pth
    return Ourmodel_only_lstm(BasicBlock, [1, 2, 2], num_classes=num_classes, channels=channels,include_top=include_top)

if __name__ == '__main__':

    model = our_model_only_lstm(4,44)
