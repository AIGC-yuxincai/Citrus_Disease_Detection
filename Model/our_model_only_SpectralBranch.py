...
class Ourmodel_only_SpectralBranch(nn.Module):
    ...
    def __init__(self,
                 ...
                 groups=1,
                 width_per_group=64):
        super(Ourmodel_only_SpectralBranch, self).__init__()
...
def our_model_only_SpectralBranch(num_classes=1000, channels=44,include_top=True):
    # https://download.pytorch.org/models/resnet50-19c8e357.pth
    return Ourmodel_only_SpectralBranch(BasicBlock, [1, 2, 2], num_classes=num_classes, channels=channels,include_top=include_top)

if __name__ == '__main__':

    model = our_model_only_SpectralBranch(4,44)
